...
public class FindPwdActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void clickVerify() {
        ...
        jsonObject.addProperty("type", Constants.SMS_TYPE_FIND_PWD);
    ...
    private void doFindPwd(){
        ...
        ApiServiceFactory.getStringApiService()
                ...
                .subscribe(new Observer<String>() {
                    ...
                    public void onNext(String stringResponse) {
                        try {
                            ...
                            if(response.isSuccess()){
                                ...
                                startActivity(intent);
                                ToastUtils.shortToast(getApplicationContext(),"找回成功～");
                                finish();
                            }else {
                                ToastUtils.shortToast(getApplicationContext(),response.getMsg());
                            }
                    ...
                    public void onError(Throwable e) {
                        e.printStackTrace();
                        ToastUtils.shortToast(getApplicationContext(),"找回失败～");
                    }
    ...
    private void destroyFindPwd(){
        if (null!=findPwdDis&&!findPwdDis.isDisposed()){
            findPwdDis.dispose();
        }
    }
