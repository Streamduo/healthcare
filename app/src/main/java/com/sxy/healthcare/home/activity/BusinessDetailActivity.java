...
public class BusinessDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private BusinessDestailFragment businessDestailFragment;
   ...
   // private CommentFragment commentFragment;
    ...
    protected void initDatas() {
       ...
       /* Bundle bundle = new Bundle();
        ...
        businessDestailFragment = new BusinessDestailFragment();
        businessDestailFragment.setArguments(bundle);
        ...
        add(businessDestailFragment,1,R.id.content,"BusinessDestailFragment");*/
...
/*            case R.id.tv_btn_comment:
    ...
    public void add(BaseFragment fragment, int type, int id,String tag){
        ...
        BusinessDestailFragment tempFragment1;
        DescFragment  tempFragment2;
        CommentFragment tempFragment3;
        if(type==1){
            //优先检查，fragment是否存在，避免重叠

            tempFragment1 = (BusinessDestailFragment) fragmentManager.findFragmentByTag(tag);
