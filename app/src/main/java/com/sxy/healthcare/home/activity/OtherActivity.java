...
import com.sxy.healthcare.home.fragment.OtherFragment;
...
public class OtherActivity extends BaseActivity  implements View.OnClickListener{
   ...
   // private CommentFragment commentFragment;
    private OtherFragment healthFragment;
    ...
    public void add(BaseFragment fragment, int type, int id,String tag){
        ...
        OtherFragment tempFragment1;
        DescFragment  tempFragment2;
        CommentFragment tempFragment3;
        if(type==1){
            //优先检查，fragment是否存在，避免重叠

            tempFragment1 = (OtherFragment) fragmentManager.findFragmentByTag(tag);
                            ...
                            if(null!=response){
                                if(response.isSuccess()){
                                   ...
                                   // commentFragment.setArguments(bundle);
                                    ...
                                    healthFragment = new OtherFragment();
