...
import com.sxy.healthcare.home.fragment.FunFragment;
...
public class FunActivity extends BaseActivity implements View.OnClickListener{
  ...
  //  private CommentFragment commentFragment;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.tv_btn_business:
                ...
                add(funFragment,1,R.id.content,"FunFragment");
                break;
    ...
    public void add(BaseFragment fragment, int type, int id,String tag){
        ...
        FunFragment tempFragment1;
        DescFragment  tempFragment2;
        CommentFragment tempFragment3;
        if(type==1){
            //优先检查，fragment是否存在，避免重叠

            tempFragment1 = (FunFragment) fragmentManager.findFragmentByTag(tag);
