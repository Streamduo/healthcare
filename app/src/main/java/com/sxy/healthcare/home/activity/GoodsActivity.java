...
import com.sxy.healthcare.home.fragment.GoodFragment;
   ...
   // private CommentFragment commentFragment;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.tv_btn_business:
                ...
                add(goodFragment,1,R.id.content,"GoodFragment");
                break;
    ...
    public void add(BaseFragment fragment, int type, int id,String tag){
        ...
        try {
            ...
            GoodFragment tempFragment1;
            DescFragment  tempFragment2;
            CommentFragment tempFragment3;
            if(type==1){
                //优先检查，fragment是否存在，避免重叠

                tempFragment1 = (GoodFragment) fragmentManager.findFragmentByTag(tag);
                            ...
                            if(null!=response){
                                if(response.isSuccess()){
                                   ...
                                   // commentFragment.setArguments(bundle);
                                    ...
                                    add(goodFragment,1,R.id.content,"HealthFragment");
