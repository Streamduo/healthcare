package com.sxy.healthcare.base.dialog;
...
public class CommonDialog extends DialogFragment {
    ...
    public static CommonDialog newInstance(String message, String cancelText, String confirmText) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.dialog_common_1, container, false);
